...
class MSCOCOSeq(BaseVideoDataset):
    ...
    def get_sequence_info(self, seq_id):
        ...
        bbox = jt.array(anno['bbox']).view(1, 4)

        # mask = jt.array(self.coco_set.annToMask(anno)).unsqueeze(dim=0)
    ...
    def get_meta_info(self, seq_id):
        ...
        try:
            ...
            language = cat_dict_current['name'] + ", " + cat_dict_current['supercategory']
